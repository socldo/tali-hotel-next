...
const Booking = () => {
    ...
    const [firstName, setFirstName] = useState(nameCookie ? nameCookie.toString() : '')
    const [lastName, setLastName] = useState('')
    const [isSubmit, setIsSubmit] = useState(0)
    const [phone, setPhone] = useState(phoneCookie ? phoneCookie.toString() : '')
    const [email, setEmail] = useState(emailCookie ? emailCookie.toString() : '')
